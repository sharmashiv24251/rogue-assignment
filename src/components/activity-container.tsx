...
const fetchActivities = async (weatherData: any) => {
...
const ActivityContainer = () => {
  ...
  const {
    ...
    queryKey: ["activities", weatherData],
    queryFn: () => fetchActivities(weatherData),
    enabled: !!weatherData,
    staleTime: 1000 * 60 * 30, // 30 minutes
  });

  const activities: Activity[] = activityData?.activities || []; // Fixed: changed Activity to Activity[]
    ...
    return (
      <div className="flex flex-col items-center justify-center h-full p-6">
        ...
        <button
          ...
          onClick={() => refetch()} // Fixed: added arrow function to properly call refetch
        >
          Try Again
        </button>
      </div>
